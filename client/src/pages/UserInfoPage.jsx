...
function UserInfoPage() {
  ...
  const opt = {
  margin: [0, 0, 0, 0], // will be handled by CSS
  ...
  jsPDF: {
    unit: 'pt', // pt gives better browser-to-PDF accuracy
    format: 'a4',
  ...
  //   documentTitle: 'Application Review',
  // });
  ...
  return (
    <div className="bg-gray-100 min-h-screen px-4 py-8 flex flex-col items-center">
      <div className="w-full max-w-5xl bg-white rounded-xl shadow p-6">
        ...
        <div ref={printRef} className="space-y-6 text-black font-[Times]">

          {/* Page 1 */}
          <PrintPage pageNumber={1} totalPages={6}>
            ...
            <div className="text-center">
              ...
              <p className="mt-2 space-y-3text-base font-semibold">
          ...
          {/* Page 2 */}
          <PrintPage pageNumber={2} totalPages={6}>
            <hr className="my-4 border-black" />
            ...
            <table className="w-full border border-black text-center text-s my-2">
              ...
              <tbody>
                {formData.schools_Attended?.map((row, i) => (
          ...
          {/* Page 3 */}
          <PrintPage pageNumber={3} totalPages={6}>
          ...
          {/* Page 4 */}
          <PrintPage pageNumber={4} totalPages={6}>
            <hr className="my-4 border-black" />
            ...
            <table className="w-full border border-black text-center text-s my-2">
              ...
              <tbody>
                {formData.other_education?.map((row, i) => (
            ...
            <table className="w-full border border-black text-center text-s my-2">
              ...
              <th className="border border-black">Effective Date</th></tr></thead>
              <tbody>
                {formData.professional?.map((row, i) => (
                  <tr key={i}><td className="border border-black">{row.institute}</td><td className="border border-black">{row.course}</td>
                  <td className="border border-black">{row.from}</td><td className="border border-black">{row.to}</td>
                  <td className="border border-black">{row.date}</td></tr>
                ))}
          ...
          {/* Page 5 */}
          <PrintPage pageNumber={5} totalPages={6}>
            ...
            <table className="w-full border border-black text-center text-s my-2">
              ...
              <tbody>
                {formData.presentOccupation?.map((row, i) => (
            ...
            <table className="w-full border text-s">
              ...
              <PrintPage pageNumber={6} totalPages={6}>
                ...
                <table className="w-full border border-black text-center text-s my-2">
                  ...
                  <tbody>
                    {formData.pastOccupation?.map((row, i) => (
                ...
                <div className="mt-16">
                      ...
                      <hr className="my-4 border-black" />
                      <p>I certify that all the particulars given by me in this application are true and accurate. I am awae that if any
                      particulars are found to be false or inaccurate prior to my selection, my application will be rejected, and
                      that if particulars found to be false or inaccurate after my selection, I will be dismissed from service
                      without any compensation. </p><br/><br/>
