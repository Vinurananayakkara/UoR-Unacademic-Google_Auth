...
const OtherEducationTable = () => {
  ...
  return (
    <div className="overflow-x-auto mb-4">
      <h3 className="font-semibold mb-2">Other Education Qualifications</h3>
...
export default OtherEducationTable;
